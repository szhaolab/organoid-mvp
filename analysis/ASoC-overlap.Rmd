...
#write.csv(all_coverages, "../data/MVP_ASoC_SNP_overlaps.csv")

```


```{r}
all_coverages <- read.csv("/dartfs/rc/lab/S/Szhao/katieh/organoid-rotation/data/MVP_ASoC_SNP_overlaps.csv", header = TRUE)
