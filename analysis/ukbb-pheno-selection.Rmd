...
pheno_manifest <- suppressWarnings(read_excel("./data/Pan-UK Biobank phenotype manifest.xlsx", sheet = "phenotype_manifest"))

h2_manifest <- suppressWarnings(read_excel("./data/Pan-UK Biobank phenotype manifest.xlsx", sheet = "h2_manifest"))
...
TenK_pheno_filtered <- TenK_pheno_filtered %>% mutate(h2_EUR_numeric = as.numeric(estimates.ldsc.h2_observed))
